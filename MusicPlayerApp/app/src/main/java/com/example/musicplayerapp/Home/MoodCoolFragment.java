...
public class MoodCoolFragment extends Fragment {

    LinearLayout mood_btn_back2;
    MoodAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_mood_cool, container, false);
        mood_btn_back2 = root.findViewById(R.id.mood_btn_back2);
        mood_btn_back2.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getData(final String kindID) {
        ...
        searchDAO.getMusicByMood(kindID, new SongCallBack() {
            ...
            public void getCallBack(ArrayList<Song> song) {
                Log.d("hehe", "123456");
                mySong = song;
                adapter = new MoodAdapter(getContext(),mySong, MoodCoolFragment.this);
