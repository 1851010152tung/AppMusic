...
public class SongOfAlbum_Adapter extends RecyclerView.Adapter<SongOfAlbum_Adapter.ViewHolder>{
    ...
    public SongOfAlbum_Adapter(Context context, ArrayList<Song> songArrayList, ListSongsByKindFragment songsListFragment) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SongOfAlbum_Adapter.ViewHolder holder, int position) {
