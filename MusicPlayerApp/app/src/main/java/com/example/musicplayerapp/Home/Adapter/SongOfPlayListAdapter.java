...
public class SongOfPlayListAdapter extends RecyclerView.Adapter<SongOfPlayListAdapter.ViewHolder>{
        ...
        ListSongsOfPlayListFragment listSongsOfPlayListFragment;

public SongOfPlayListAdapter(Context context, ArrayList<Song> songArrayList, ListSongsOfPlayListFragment listSongsOfPlayListFragment) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SongOfPlayListAdapter.ViewHolder holder, int position) {
