...
//    Thêm người người dùng vào FireStore
    public void signUp(String ID, String Username, String Password, String Email,String Image,String Phone, final SucessCallBack sucessCallBack){
        userInfor = new UserInfor(ID,Username,null,Password,Email, Image,Phone) ;
