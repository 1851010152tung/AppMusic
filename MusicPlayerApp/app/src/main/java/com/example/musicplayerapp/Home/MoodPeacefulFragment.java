...
public class MoodPeacefulFragment extends Fragment {

   ImageView mood_btn_back4;
    MoodAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_mood_peaceful, container, false);
        mood_btn_back4 = root.findViewById(R.id.mood_btn_back4);
        mood_btn_back4.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getData(final String kindID) {
        ...
        searchDAO.getMusicByMood(kindID, new SongCallBack() {
            ...
            public void getCallBack(ArrayList<Song> song) {
                Log.d("hehe", "123456");
                mySong = song;
                adapter = new MoodAdapter(getContext(),mySong, MoodPeacefulFragment.this);
