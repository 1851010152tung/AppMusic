...
public class SongOfTrendingPlayListAdapter extends RecyclerView.Adapter<SongOfTrendingPlayListAdapter.ViewHolder>{
        Context context;
        ArrayList<Song> songArrayList;
        ListSongsOfTrendingPlayListFragment listSongsOfPlayListFragment;

public SongOfTrendingPlayListAdapter(Context context, ArrayList<Song> songArrayList, ListSongsOfTrendingPlayListFragment listSongsOfPlayListFragment) {
        this.context = context;
        this.songArrayList = songArrayList;
        this.listSongsOfPlayListFragment = listSongsOfPlayListFragment;
}
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SongOfTrendingPlayListAdapter.ViewHolder holder, int position) {
