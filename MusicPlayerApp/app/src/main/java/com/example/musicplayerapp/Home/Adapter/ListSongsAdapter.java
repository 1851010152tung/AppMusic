...
import com.example.musicplayerapp.Home.ListSongsFragment;
...
public class ListSongsAdapter extends RecyclerView.Adapter<ListSongsAdapter.ViewHolder>{
    ...
    ListSongsFragment songsFragment;



    public ListSongsAdapter(Context context, ArrayList<Song> songArrayList, ListSongsFragment songsFragment) {
