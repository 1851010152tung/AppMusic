...
public class MoodCarefreeFragment extends Fragment {

    LinearLayout mood_btn_back1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_mood_carefree, container, false);
        UserInfor userInfor = UserInfor.getInstance();
        kindID = userInfor.getKindID();
        getData(kindID);
        mood_btn_back1 = root.findViewById(R.id.mood_btn_back1);
        ...
        mood_btn_back1.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getData(final String kindID) {
        ...
        searchDAO.getMusicByMood(kindID, new SongCallBack() {
            ...
            public void getCallBack(ArrayList<Song> song) {
                Log.d("hehe", "123456");
                mySong = song;
                adapter = new MoodAdapter(getContext(),mySong,MoodCarefreeFragment.this);
