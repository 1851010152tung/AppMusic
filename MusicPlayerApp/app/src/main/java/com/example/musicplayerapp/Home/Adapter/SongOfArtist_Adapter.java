...
public class SongOfArtist_Adapter extends RecyclerView.Adapter<SongOfArtist_Adapter.ViewHolder>{
    Context context;
    ArrayList<Song> songArrayList;
    ListSongOfArtistFragment listSongOfArtist;

    public SongOfArtist_Adapter(Context context, ArrayList<Song> songArrayList, ListSongOfArtistFragment listSongOfArtist) {
        this.context = context;
        this.songArrayList = songArrayList;
        this.listSongOfArtist = listSongOfArtist;
    }
    @NonNull
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SongOfArtist_Adapter.ViewHolder holder, int position) {
