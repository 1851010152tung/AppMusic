...
public class MoodSadFragment extends Fragment {
   ImageView mood_btn_back5;
    MoodAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_mood_sad, container, false);
        mood_btn_back5 = root.findViewById(R.id.mood_btn_back5);
        mood_btn_back5.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getData(final String kindID) {
        ...
        searchDAO.getMusicByMood(kindID, new SongCallBack() {
            ...
            public void getCallBack(ArrayList<Song> song) {
                Log.d("hehe", "123456");
                mySong = song;
                adapter = new MoodAdapter(getContext(),mySong, MoodSadFragment.this);
